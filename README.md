...
- 🔐 JWT login with 6 roles, each seeing only the modules they're allowed to (matches the role-access matrix)
- 🏠 Residents, Units/Flats, Visitors, Complaints, Maintenance management
- 📢 Notice Board, Amenities booking status, Documents
- 💰 Finance dashboard (collections, expenses, invoices, charts)
